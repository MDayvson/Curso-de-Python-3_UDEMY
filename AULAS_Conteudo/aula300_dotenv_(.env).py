...
# e criar um outro arquivo chamado de .env-exemple, para avisar a outros
# desenvolvedores que eles devem criar o arquivo.env
...
de configuração para armazenar e acessar as suas variáveis de ambiente de
forma  mais fácil e segura em seus projetos.
...
pip install python-dotenv
Esse arquivo deve conter as suas variáveis de ambiente e seguir o seguinte
formato:
...
Em seu código, você pode acessar essas variáveis usando o módulo os e a função
os.getenv(), por exemplo:
...
confidenciais em seu código ou em repositórios de código compartilhados, pois
o arquivo .env pode ser adicionado ao .gitignore para não ser incluído nos
commits. Crie um .env-example para exemplificar como usar o seu programa com
valores fictícios.

Além disso, o python-dotenv também permite que você use um arquivo .env para
armazenar valores de configuração específicos de cada ambiente, o que pode ser
útil quando você estiver trabalhando em um projeto com diferentes ambientes de
